        ...
        <div class="row">
            ...
            <div class="card col-lg-4 mb-3 mt-5">
                ...
                <div class="card-body text-gray-900">
                    <h6 class="text-center">Login Buku Tamu</h6>
                    <form class="user" action="cek_login.php" method="post"> <br>
                        <div class="form-group text-gray-900">
                            <input type="text" name="username" class="form-control" placeholder="Username" required>
                        </div>
                        <div class="form-group">
                            <input type="password" name="password" id="passwordKu" class="form-control" placeholder="Password" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="footer">
                            <footer class="text-center mt-2 text-muted">
                                <small>Copyright &copy <a href="index.php">Dukcapil Gunungkidul</a> 2024 - <?= date("Y") ?></small>
                            </footer> <br>
                        </div>
                    </form>
                </div>
